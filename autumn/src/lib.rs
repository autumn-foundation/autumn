...
/// Threaded, polymorphic comments (#1367).
///
/// Autumn's fifth association kind. See [`commentable`] for the
/// `#[commentable]` attribute, the repository helpers, and the
/// registry-driven generic router.
#[cfg(feature = "db")]
pub mod commentable;
