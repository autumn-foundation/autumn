...
-- Postgres migration in `autumn/migrations/`. The version dir name is kept
-- identical so `__diesel_schema_migrations` bookkeeping does not diverge
-- across backends. Differences from the Postgres DDL:
