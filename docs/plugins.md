...
| `autumn-billing` | `billing_customers`, `billing_subscriptions`, `billing_invoices`, `billing_events`, `billing_dunning` | its `migrations/20260910000000_billing_mirror`, registered through `plugin_migrations` so the app's normal migration run applies it |
