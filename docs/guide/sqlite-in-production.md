...
`#[scheduled]` tasks #1907, scrub and retention sweeps #2553). Backup/restore and
`autumn deploy` data-file persistence landed in #1909. A **Planned** row does
**not** mean the app refuses to boot — the runtime
