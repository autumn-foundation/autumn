...
2026-09-12T13:58Z to 2026-09-13T09:02Z (~19 hours, two pages of the workflow-run
list, 100+ runs each). Triaged every non-cancelled failure by job/log
inspection rather than by branch name:
